...
import { getSupabase, type GalleryImageRow } from "@/lib/supabase";
...
function GalleryAdmin() {
  ...
  return (
    <div>
      <PageHeader
        title="Galería"
        subtitle="Gestioná los items del mosaico público (orden, descripción, visibilidad)."
      />

      <Card className="mb-6">
        <h2 className="text-sm font-bold text-slate-900">Agregar por URL</h2>
        <p className="mt-1 text-xs text-slate-500">
          Pegá la ruta de un archivo existente (ej: <code>/galeria/galeria-22.jpg</code>) o una URL completa.
        </p>
      ...
      {loading ? (
        ...
        <EmptyState message="No hay items en la galería." />
      ) : (
